...
currentdepth_rules['authorized_data_files'] = [['^$']]
currentdepth_rules['authorized_metadata_files'] = [['^sub-([a-zA-Z0-9]+)_ses-([a-zA-Z0-9]+)_scans', ANY_METADATA_EXT]]
currentdepth_rules['mandatory_files'] = [['^sub-([a-zA-Z0-9]+)_ses-([a-zA-Z0-9]+)_scans',['.tsv']]]
RULES_SET.append(currentdepth_rules)
# level 3
currentdepth_rules={}
...
currentdepth_rules['mandatory_files'] = [
    ...
    ['^sub-([a-zA-Z0-9]+)_ses-([a-zA-Z0-9]+)([\\w\\-]*)_events', ['.tsv']]
    ]
RULES_SET.append(currentdepth_rules)
